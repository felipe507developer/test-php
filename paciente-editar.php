                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-center mt-4">
                                    <a type="button" href="pacientes.php" class="btn btn-warning light mr-2 btn-sm" id="#">Atrás</a>
                                    <button type="button" class="btn btn-primary ml-2 btn-sm" id="boton-guardar">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
